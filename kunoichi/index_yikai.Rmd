...
```{r, echo= F, out.width= '100%', warning=F, message= F, dpi= 300}
...
```{r rainplot, echo = F, warning=F, eval=F, message=F, dpi=300, cache= T}
# We could visualize the distributino of variable OverallQual in a rainplot
