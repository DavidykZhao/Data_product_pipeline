...
# XGBoost model was used to achieve great .orange[predicability] and .orange[explanabiity], 
...
# We could also visualize the .purple[SHAP] values<sup>1</sup> of each variable
<br>
<br>
<br>
<br>
