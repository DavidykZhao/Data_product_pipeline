...
```{r}
train <- read.csv("train_house.csv", stringsAsFactors = F)
test <- read.csv("test_house.csv", stringsAsFactors = F)
```
...
```{r}
# interaction plots
shap.plot.dependence(data_long = shap_long, x = 'TotalSqFeet', y = 'TotalSqFeet', color_feature = 'OverallQual') + ggtitle("(A) SHAP values of TotalSqFeet vs. TotalSqFeet")+
...
saveRDS(shap_int, "shap_interaction_plot_data")
