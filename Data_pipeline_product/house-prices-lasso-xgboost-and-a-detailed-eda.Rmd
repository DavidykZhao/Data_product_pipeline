...
```{r}
xgbcv <- xgb.cv( params = default_param, data = dtrain, nrounds = 301, nfold = 5, showsd = T, stratified = T, print_every_n = 40, early_stopping_rounds = 10, maximize = F)
```
...
xgb_mod <- xgb.train(data = dtrain, params=default_param, nrounds = 183)
```
